...
import ItemsRSDb from '../firebase/ItemsRSDB';
...
import { ContentElemenMov, ContentElemenSelect, Formulario, Label } from '../elementos/CrearEquipos';
import { ContenedorProveedor, Contenedor, ContentElemenAdd, ListarProveedor, Titulo, InputAdd, Boton } from '../elementos/General';

const ItemsRepuestosServicios = () => {
    ...
    const getData = async () => {
        const traerit = collection(db, 'itemsrs');
    ...
    const handleSubmit = (e) => {
        ...
        if (!botonDisabled) {
            ...
            if (!existe) {
                ...
                cambiarAlerta({
                    tipo: 'error',
                    mensaje: 'No ha ingresado un Valor'
                })
            } else {
    ...
    return (
        <ContenedorProveedor style={{ width: '90%' }}>
            <Contenedor>
                <Titulo>Items Repuestos y Servicios</Titulo>
            </Contenedor>
            ...
            <Contenedor>
                <Formulario action=''>
                    ...
                    <ContentElemenMov>
                        <ContentElemenSelect>
                            <Label>Ingrese el valor del Repuesto o Servicio</Label>
                            <InputAdd
                                type='number'
                                placeholder='Valor'
                                name='precio'
...
export default ItemsRepuestosServicios;